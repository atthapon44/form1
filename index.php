    ...
    <div class="container">
        <form action="">
            <div class="thumbnail01">
                    ...
                    <div class="col-sm-2 control-label">
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select" id="inputGroupSelect03" required>
                                ...
                                <option value="9">ประจวบคีรีขันธ์</option>
                                <option value="10">เพชรบุรี</option>
                                <option value="11">ปัตตานี</option>
                                <option value="12">ยะลา</option>
                                <option value="13">นราธิวาส</option>
              ...
              <div class="form-row">
                <label for="text">ผู้ติดต่อฉุกเฉิน:*</label>
                <input type="text" required class="form-control" id="address">
            </div>
            <br>
            ...
            <div class="col-sm-2 control-label">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <label class="input-group-text" for="inputGroupSelect03">เกี่ยวข้องเป็น (อื่นๆ โปรดระบุ)</label>
                    </div>
                    <select class="custom-select" id="inputGroupSelect03" required>
                        ...
                        <option value="4">น้า/อา</option>
                        <option value="5">อื่นๆ</option>
                     
                        <div class="form-row">
                            <label for="text">อื่นๆ โปรดระบุ":*</label>
                            <input type="text" required class="form-control" id="address">
                        </div>
                        <br>
